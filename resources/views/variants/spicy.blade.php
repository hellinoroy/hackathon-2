...
<div class="relative mb-12">
    {{-- Gambar Latar --}}
    <div class="h-72 w-full bg-cover bg-center" style="background-image: url('/images/Spicy.jpg');">
    </div>
    ...
    <div class="absolute inset-0 flex items-center justify-center">
        {{-- Anda bisa mengubah teks ini, misal menjadi "Our Collection" --}}
        <h1 class="text-6xl font-bold text-white">Spicy</h1>
    </div>
</div>
