...
<div class="container mx-auto px-4 py-12 text-center">
    <h1 class="text-4xl font-bold">Fresh Variant</h1>
    <p class="mt-4">Tampilkan parfum Fresh di sini.</p>
</div>
<div class="container mx-auto px-4 py-10">
    <h1 class="text-3xl font-bold mb-8 text-center">Fresh Variant</h1>
