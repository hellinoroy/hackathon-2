...
@section('content')
    ...
    <div class="mt-8 flex items-center gap-2">
        ...
        <button class="px-4 py-2 rounded-md bg-gray-800 text-white text-sm font-semibold">1</button>
        <button class="px-4 py-2 rounded-md hover:bg-gray-200 text-sm">2</button>
