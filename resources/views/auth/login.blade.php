...
<head>
    ...
    <title>Login - {{ config('app.name', 'Evoste') }}</title>
            ...
            <div class="container mx-auto">
                <div class="flex flex-col md:flex-row items-center justify-center gap-16 bg-white p-8 rounded-lg">
                    ...
                    <div class="w-full md:w-1/2 lg:w-4/12">
                        <div class="text-left">
                            <h2 class="text-3xl font-bold text-gray-800">Halo, Selamat Datang kembali! 👋</h2>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="mt-8">
                            ...
                            <div class="relative mb-4">
                                ...
                                <input id="email" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500" placeholder="Masukkan email kamu kesini">
                            ...
                            <div class="relative mb-4">
                                ...
                                <input id="password" type="password" name="password" required autocomplete="current-password" class="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500" placeholder="Kata sandi kamu">
        ...
        <footer class="bg-gray-900 text-gray-400">
            <div class="container mx-auto px-6 py-12">
                <div class="grid grid-cols-2 md:grid-cols-5 gap-8">
                    ...
                    <div>
                        <h4 class="font-bold text-white mb-4">Our Product</h4>
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="hover:text-white">Floral</a></li>
                            <li><a href="#" class="hover:text-white">Aesty</a></li>
                            <li><a href="#" class="hover:text-white">Fresh</a></li>
                            <li><a href="#" class="hover:text-white">Spicy</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="font-bold text-white mb-4">Find Your Scent</h4>
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="hover:text-white">Find Your Scent</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="font-bold text-white mb-4">About Evoste</h4>
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="hover:text-white">Success</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="font-bold text-white mb-4">Contact Us</h4>
                         <ul class="space-y-2 text-sm">
                            <li><a href="#" class="hover:text-white flex items-center space-x-2"><span>Whatsapp:</span> <span>+6285-XXXX-XXXX</span></a></li>
                            <li><a href="#" class="hover:text-white flex items-center space-x-2"><span>Instagram:</span> <span>@evosteid</span></a></li>
                        </ul>
                    </div>
                </div>
